...
export default function Home() {
  ...
  const filteredSubstances = useMemo(() => {
    return allSubstances.filter((substance) => {
      // Filtro de búsqueda (nombre, mecanismo, fórmula o receptores)
      if (searchQuery.trim() !== '') {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-lowest">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Mostrar Sidebar solo en catálogo y tabla */}
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
          {/* Banner Hero Clínico */}
          <div className="relative rounded-biotech border border-surface-bright bg-surface-low p-6 overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl space-y-2">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-primary/10 border border-primary/30 text-xs font-mono text-primary font-semibold">
                ...
                <span>INDEXACIÓN CIENTÍFICA ACTIVA — MÓDULOS 1 & 2 CARGADOS</span>
              </div>
