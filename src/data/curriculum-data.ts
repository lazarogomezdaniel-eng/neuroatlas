...
export const CURRICULUM_MODULES: ModuleItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Psicobióticos, permeabilidad intestinal y tono vagal',
    icon: '🦠',
    color: '#14B8A6',
    ...
    readTime: '3-4 h',
    sections: [
      { id: '7-1', number: '7.1', title: 'Psicobióticos & Cepas Clave', href: '/modulos/modulo-7#7-1-psicobioticos', conceptCount: 4 },
      { id: '7-2', number: '7.2', title: 'Permeabilidad & Neuroinflamación', href: '/modulos/modulo-7#7-2-permeabilidad', conceptCount: 3 },
      { id: '7-3', number: '7.3', title: 'Ácidos Grasos Cadena Corta (AGCC)', href: '/modulos/modulo-7#7-3-agcc', conceptCount: 3 },
      { id: '7-4', number: '7.4', title: 'Estimulación del Nervio Vago', href: '/modulos/modulo-7#7-4-nervio-vago', conceptCount: 4 }
    ]
  },
  {
    id: 'modulo-8',
    ...
    subtitle: 'Frío, sauna, respiración, hipoxia intermitente y fotobiología',
    icon: '🧊',
    color: '#06B6D4',
    ...
    readTime: '3-4 h',
    sections: [
      { id: '8-1', number: '8.1', title: 'Exposición al Frío & Crioterapia', href: '/modulos/modulo-8#8-1-frio', conceptCount: 3 },
      { id: '8-2', number: '8.2', title: 'Termoterapia & Sauna Infrarrojo', href: '/modulos/modulo-8#8-2-sauna', conceptCount: 3 },
      { id: '8-3', number: '8.3', title: 'Hipoxia Intermitente & Respiración', href: '/modulos/modulo-8#8-3-respiracion', conceptCount: 3 },
      { id: '8-4', number: '8.4', title: 'Ayuno Intermitente & Cetosis', href: '/modulos/modulo-8#8-4-cetosis', conceptCount: 3 },
      { id: '8-5', number: '8.5', title: 'Bio-Frecuencias & Fotobiología Ambiental', href: '/modulos/modulo-8#8-5-fotobiologia', conceptCount: 3 }
    ]
  },
  {
    id: 'modulo-9',
