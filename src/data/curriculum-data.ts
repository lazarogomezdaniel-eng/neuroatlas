...
export const CURRICULUM_MODULES: ModuleItem[] = [
  ...
  },
  {
    ...
    subtitle: 'Sinergias farmacológicas, timing circadiano y protocolos clínicos de referencia',
    icon: '🎯',
    color: '#F59E0B',
    ...
    readTime: '3-4 h',
    sections: [
      { id: '10-1', number: '10.1', title: 'Principios del Stacking', href: '/modulos/modulo-10#seccion-10-1', conceptCount: 3 },
      { id: '10-2', number: '10.2', title: 'Stacks Clásicos (Huberman, Attia)', href: '/modulos/modulo-10#seccion-10-2', conceptCount: 4 },
      { id: '10-3', number: '10.3', title: 'Stacks por Objetivo (Foco, Memoria, Sueño, Ánimo)', href: '/modulos/modulo-10#seccion-10-3', conceptCount: 4 },
      { id: '10-4', number: '10.4', title: 'Seguridad e Interacciones Peligrosas', href: '/modulos/modulo-10#seccion-10-4', conceptCount: 2 },
      { id: '10-5', number: '10.5', title: 'Personalización & Monitoreo de Stacks', href: '/modulos/modulo-10#seccion-10-5', conceptCount: 2 }
    ]
  },
  {
    id: 'modulo-11',
    number: 11,
    romanNumeral: 'XI',
    title: 'Poblaciones y Condiciones Específicas',
    subtitle: 'TDAH, depresión, Alzheimer, programadores, atletas y protocolos terapéuticos',
    icon: '🧬',
    color: '#14B8A6',
    ...
    readTime: '3-4 h',
    sections: [
      { id: '11-1', number: '11.1', title: 'Salud Mental & Trastornos Clínicos', href: '/modulos/modulo-11#seccion-11-1', conceptCount: 4 },
      { id: '11-2', number: '11.2', title: 'Perfiles Profesionales (Programador, Atleta)', href: '/modulos/modulo-11#seccion-11-2', conceptCount: 2 },
      { id: '11-3', number: '11.3', title: 'Poblaciones Específicas (Adolescentes, Mayores, Mujeres)', href: '/modulos/modulo-11#seccion-11-3', conceptCount: 3 },
      { id: '11-4', number: '11.4', title: 'Protocolos Terapéuticos (Neurodegeneración, Estrés Crónico)', href: '/modulos/modulo-11#seccion-11-4', conceptCount: 2 }
    ]
  },
  {
    id: 'modulo-12',
    number: 12,
    romanNumeral: 'XII',
    title: 'Criterios de Calidad & Anti-Estafas',
    subtitle: 'Evaluación analítica, biodisponibilidad y detección de engaños sin sesgos comerciales',
    icon: '🛡️',
    color: '#EAB308',
    ...
    readTime: '1-2 h',
    sections: [
      { id: '12-1', number: '12.1', title: 'Evaluación de Suplementos & Certificaciones', href: '/modulos/modulo-12#seccion-12-1', conceptCount: 1 },
      { id: '12-2', number: '12.2', title: 'Calidad & Relación Costo-Eficacia', href: '/modulos/modulo-12#seccion-12-2', conceptCount: 1 },
      { id: '12-3', number: '12.3', title: 'Detección de Estafas & Pseudociencia', href: '/modulos/modulo-12#seccion-12-3', conceptCount: 2 }
    ]
  }
];
